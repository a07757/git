...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/jdenner/gui/img/tiger_refined_aqua_retouch_by_keyzersoze.jpg"))); // NOI18N
        desktopPane.add(jLabel1);
        jLabel1.setBounds(0, -30, 1790, 1260);
        ...
        jMenuItem1.setText("Consulta Estoque");
        jMenuItem1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem1ActionPerformed(evt);
            }
        });
        menuMovimentos.add(jMenuItem1);
        ...
        setSize(new java.awt.Dimension(904, 705));
